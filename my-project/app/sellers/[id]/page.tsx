...
const SELLERS: Record<number, any> = {
  1: {
    name: "Clay Artistry",
    rating: 4.8,
    products: 24,
    ...
    items: ["Handmade Ceramic Vase", "Macramé Wall Hanging"],
  },
  2: {
    name: "Wood Crafters",
    rating: 4.9,
    ...
    items: ["Wooden Cutting Board", "Wooden Jewelry Box"],
  },
  3: {
    name: "Leather Works",
    rating: 4.7,
